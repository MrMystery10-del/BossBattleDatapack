...
execute if score WORLD temp matches 0 as @e[type=marker,tag=magma_orb] at @s if entity @p[distance=..3] run function bossbattle:boss/pyroclast/attacks/orb_hit

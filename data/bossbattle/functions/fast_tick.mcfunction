...
## Display stats
execute as @a run title @s actionbar ["",{"text":"Strength: ","bold":true,"color":"red"},{"score":{"name":"@s","objective":"strenght"},"color":"white"},{"text":"\u262f","color":"red"},{"text":" \u0020Resistance: ","bold":true,"color":"green"},{"score":{"name":"@s","objective":"resistance"},"color":"white"},{"text":"\u06de","color":"green"},{"text":" \u0020Movement:","bold":true,"color":"aqua"},{"text":" "},{"score":{"name":"@s","objective":"movement"}},{"text":"\u262e","color":"aqua"}]
